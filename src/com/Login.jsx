...
export default function Login() {
  ...
  return (
    <div>
      ...
      <a className="text-end mt-4" href='/'>Забыли пороль?</a>
      <button type="submit" className="text-white bg-gray-800 hover:border mt-4 hover:text-black hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm mx-auto w-1/2 px-5 py-2.5 text-center" onClick={handleLogin}>Войти</button>
